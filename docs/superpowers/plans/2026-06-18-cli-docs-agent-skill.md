...
test("agent skill screen is review-first", () => {
  ...
  expect(view.body).toContain("gh skill preview miguelgarglez/personal-video-digest video-digest");
  expect(view.body).toContain("gh skill install miguelgarglez/personal-video-digest video-digest");
