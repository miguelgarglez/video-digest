...
- [ ] **Phase 1: Build configuration, runtime setup, and Artifact Library foundations**
...
- [ ] **Phase 2: Build direct CLI and artifact contracts**
...
- [ ] **Phase 3: Build the guided human TUI**
...
- [ ] **Phase 4: Publish documentation and the portable skill in-repository**
